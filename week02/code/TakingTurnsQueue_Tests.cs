...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected result starts with 'bob', actual found was 'sue'.
    ...
    // Defect(s) Found: Expected result starts with 'tim', actual found was 'sue'.
    ...
    // Defect(s) Found: Passed. No errors.
